...
// Row component for virtualized list - must be defined outside main component
const FileRow: React.FC<{
  ...
  onFileSelect?: (file: MusicFile) => void;
  onToggleFileSelection?: (filePath: string) => void;
}> = ({ index, style, files, selectedFiles, multiSelectMode, onFileSelect, onToggleFileSelection }) => {
